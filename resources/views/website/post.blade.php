        ...
        <div class="row same-height justify-content-center">
            <div class="col-md-12 col-lg-10">
                <div class="post-entry text-center">
                    <span class="post-category text-white bg-success mb-3">name</span>
                    <h1 class="mb-4"><a href="javascript:void()">title</a></h1>
                    <div class="post-meta align-items-center text-center">
                        ...
                        <span class="d-inline-block mt-1">By nam</span>
                        <span>&nbsp;-&nbsp; </span>
                    </div>
                </div>
            </div>
